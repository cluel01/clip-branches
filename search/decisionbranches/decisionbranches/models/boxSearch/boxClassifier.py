...
class BoxClassifier(BoxSearch):
    def __init__(self,tot_feat,n_feat=None,n_ind=None,max_feat="all",postTree=False,n_jobs=1,
                    cfg=None,feats=None,feat_cfg=None,indices=None, verbose=True,debug=False,dtype="float64",dtype_int="int32",seed=42):
        '''
        ...
        if indices is not None:
            ...
            self.build_indices(n_feat=n_feat,n_ind=n_ind,tot_feat=tot_feat,max_feat=max_feat,feats=feats,feat_cfg=feat_cfg)
